...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center py-12">
      ...
      <div className="absolute top-20 right-20 w-32 h-32 bg-secondary/10 rounded-full blur-2xl animate-pulse-soft" />
      <div className="absolute bottom-20 left-20 w-40 h-40 bg-primary/10 rounded-full blur-2xl animate-pulse-soft" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <Card className="glass animate-scale-in">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-foreground-muted">Join VisionX and start analyzing images</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full btn-primary py-3" disabled={!formData.agreeToTerms}>
                Create Account
              </Button>
            </form>
